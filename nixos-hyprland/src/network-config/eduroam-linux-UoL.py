...
class Messages:
    ...
    save_wpa_conf = "AAAAAAAAAAAa NetworkManager configuration failed. " \
...
Messages.save_wpa_conf = "AAAAAAAAAA NetworkManager configuration failed, but we " \
